...
const TechStack = () => {
    return (
        <div className="w-full px-4 sm:px-6 md:px-12 lg:px-32 py-12 sm:py-20 md:py-28 lg:py-40 mx-auto">
            <div className="mx-auto text-center">
                ...
                >
                    {technologies.map((tech) => (
                        <motion.div
                            key={tech.name}
                            className="flex flex-col items-center p-4 bg-white dark:bg-neutral-800 rounded-lg shadow-md"
                        >
                            {tech.icon}
